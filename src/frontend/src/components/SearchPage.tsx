      ...
      <section className="hero-bg hex-pattern relative overflow-hidden">
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl py-14 sm:py-20">
          ...
          >
            ...
            <p className="text-white/70 font-body text-base sm:text-lg mb-8 leading-relaxed">
            ...
            <motion.div
              ...
              className="glass-search rounded-xl p-1.5 flex gap-2 max-w-xl mx-auto shadow-2xl"
            >
          ...
          <div>
            {isSearching ? (
              <h2 className="font-display font-semibold text-xl text-foreground">
                Results for <span className="text-primary">"{activeCity}"</span>
              </h2>
            ) : (
              <h2 className="font-display font-semibold text-xl text-foreground">
                All CNG Stations
